...
assign collision = (drawing_request_smiley && drawing_request_boarders) || (drawing_request_smiley && drawing_request_number);// any collision --> comment after updating with #4 or #5 
